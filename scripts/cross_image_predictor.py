...
def main():
    ...
    parser.add_argument(
        "--box", type=float, nargs=4, required=True, help="Bounding box in [x, y, w, h] format for img1"
    )
    parser.add_argument(
        "--threshold", type=float, default=0.5, help="Confidence threshold for segmentation (default: 0.5)"
    )
    parser.add_argument(
        "--output1", type=str, default="image1_segmentation.png", help="Path to save image 1 segmentation"
    )
    parser.add_argument(
        "--output2", type=str, default="image2_segmentation.png", help="Path to save image 2 segmentation"
    )
